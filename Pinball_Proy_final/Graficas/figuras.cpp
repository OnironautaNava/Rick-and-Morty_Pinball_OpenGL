...
void CFiguras::prisma1 (float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3)  //Funcion creacion prisma
{
    
    GLfloat vertice [8][3] = {
        {(float)(0.5*largo) ,(float)(-0.5*altura), (float)(0.5*profundidad)},    //Coordenadas Vértice 1 V1
        {(float)(-0.5*largo) ,(float)(-0.5*altura) ,(float)(0.5*profundidad)},    //Coordenadas Vértice 2 V2
        {(float)(-0.5*largo) ,(float)(-0.5*altura) , (float)(-0.5*profundidad)},    //Coordenadas Vértice 3 V3
        {(float)(0.5*largo) ,(float)(-0.5*altura) ,(float)(-0.5*profundidad)},    //Coordenadas Vértice 4 V4
        {(float)(0.5*largo) ,(float)(0.5*altura) , (float)(0.5*profundidad)},    //Coordenadas Vértice 5 V5
        {(float)(0.5*largo) ,(float)(0.5*altura) ,(float)(-0.5*profundidad)},    //Coordenadas Vértice 6 V6
        {(float)(-0.5*largo) ,(float)(0.5*altura) ,(float)(-0.5*profundidad)},    //Coordenadas Vértice 7 V7
        {(float)(-0.5*largo) ,(float)(0.5*altura) ,(float)(0.5*profundidad)},    //Coordenadas Vértice 8 V8
				};
    ...
    glTexCoord2f(1.0f, 0.2f); glVertex3fv(vertice[3]);
    ...
    glNormal3f(-1.0f, 0.0f, 0.0f);
    glTexCoord2f(1.0f, 0.2f); glVertex3fv(vertice[1]);
    glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[7]);
    glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
    glTexCoord2f(0.0f, 0.2f); glVertex3fv(vertice[2]);
    glEnd();
...
void CFiguras::prisma_c(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3,GLuint text4, GLuint text5)  //Funcion creacion prisma
{
    ...
    GLfloat vertice [8][3] = {
        ...
        {(float)(-0.5*largo) ,(float)(-0.5*altura) , (float)(-0.5*profundidad)},    //Coordenadas Vértice 3 V3
        {(float)(0.5*largo) ,(float)(-0.5*altura) ,(float)(-0.5*profundidad)},    //Coordenadas Vértice 4 V4
        {(float)(0.3*largo) ,(float)(0.5*altura) , (float)(0.5*profundidad)},    //Coordenadas Vértice 5 V5
        {(float)(0.3*largo) ,(float)(0.5*altura) ,(float)(-0.5*profundidad)},    //Coordenadas Vértice 6 V6
        {(float)(-0.3*largo) ,(float)(0.5*altura) ,(float)(-0.5*profundidad)},    //Coordenadas Vértice 7 V7
        {(float)(-0.3*largo) ,(float)(0.5*altura) ,(float)(0.5*profundidad)},    //Coordenadas Vértice 8 V8
				};
    
    glBindTexture(GL_TEXTURE_2D, text);   // choose the texture to use.
    glBegin(GL_POLYGON);	//Front
    glNormal3f( 0.0f, 0.0f, 1.0f);
    glTexCoord2f(0.0f, 0.1f); glVertex3fv(vertice[0]);
    glTexCoord2f(0.2f, 0.9f); glVertex3fv(vertice[4]);
    glTexCoord2f(0.8f, 0.9f); glVertex3fv(vertice[7]);
    glTexCoord2f(1.0f, 0.1f); glVertex3fv(vertice[1]);
    glEnd();
    ...
    glNormal3f( 1.0f, 0.0f, 0.0f);
    glTexCoord2f(0.0f, 0.1f); glVertex3fv(vertice[0]);
    glTexCoord2f(0.8f, 0.1f); glVertex3fv(vertice[3]);
    glTexCoord2f(0.8f, 0.9f); glVertex3fv(vertice[5]);
    glTexCoord2f(0.0f, 0.9f); glVertex3fv(vertice[4]);
    glEnd();
    
    glBindTexture(GL_TEXTURE_2D, text2);   // choose the texture to use.
    glBegin(GL_POLYGON);	//Back
    glNormal3f( 0.0f, 0.0f,-1.0f);
    glTexCoord2f(0.2f, 0.95f); glVertex3fv(vertice[6]);
    glTexCoord2f(0.8f, 0.95f); glVertex3fv(vertice[5]);
    glTexCoord2f(1.0f, 0.05f); glVertex3fv(vertice[3]);
    glTexCoord2f(0.0f, 0.05f); glVertex3fv(vertice[2]);
    glEnd();
    ...
    //glColor3f(1.0,1.0,1.0);
    glNormal3f(-1.0f, 0.0f, 0.0f);
    glTexCoord2f(0.8f, 0.1f); glVertex3fv(vertice[2]);
    glTexCoord2f(0.8f, 0.9f); glVertex3fv(vertice[6]);
    glTexCoord2f(0.0f, 0.9f); glVertex3fv(vertice[7]);
    glTexCoord2f(0.0f, 0.1f); glVertex3fv(vertice[1]);
    glEnd();
...
void CFiguras::prisma_F(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3)  //Funcion creacion prisma
{
    ...
    glNormal3f( 0.0f, 0.0f, 1.0f);
    glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
    glTexCoord2f(0.2f, 0.95f); glVertex3fv(vertice[4]);
    glTexCoord2f(0.8f, 0.95f); glVertex3fv(vertice[7]);
    glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
    glEnd();
...
void CFiguras::prisma2 (GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			glNormal3f( 0.0f, 0.0f, 1.0f);
			glTexCoord2f(0.5f, 0.5f); glVertex3fv(vertice[0]);
			glTexCoord2f(0.51f, 0.5f); glVertex3fv(vertice[4]);
			glTexCoord2f(0.51f,0.51f); glVertex3fv(vertice[7]);
			glTexCoord2f(0.5f, 0.51f); glVertex3fv(vertice[1]);
		glEnd();
...
void CFiguras::cilindro(float radio, float altura, int resolucion, GLuint text)
{
	...
	for(int i=0; i <resolucion; i++)
	{
		...
		glBegin(GL_POLYGON);
			glNormal3f( 0.0f, -1.0f, 0.0f);
			glVertex3f(0.0,0.0,0.0);
            glTexCoord2f(ctext_s*(i+1), 1.0f); glVertex3fv(v2);
		...
		glBegin(GL_POLYGON);
			...
			glTexCoord2f(ctext_s*i, 0.0f);	 glVertex3fv(v4);
...
///////////////////////////////
void CFiguras::esquina(GLuint textura1, GLuint textura2)  //Funcion creacion
{
...
void CFiguras::caja(GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
...
void CFiguras::caja1(GLuint textura1, GLuint textura2, GLuint textura3)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(0.5f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.5f, 0.5f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.0f, 0.5f); glVertex3fv(vertice[7]);
	glEnd();
...
void CFiguras::caja2(GLuint textura1, GLuint textura2, GLuint textura3)
{
...
void CFiguras::pata(GLuint textura1)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.5f, 0.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.5f, 0.5f); glVertex3fv(vertice[6]);
	glTexCoord2f(1.0f, 0.5f); glVertex3fv(vertice[5]);
	glEnd();

	glBegin(GL_POLYGON);  //Bottom
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.5f, 0.5f); glVertex3fv(vertice[1]);
	glTexCoord2f(1.0f, 0.5f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[3]);
...
void CFiguras::TexturaConCorrimiento(GLuint textura1, float varX, float varY)  //Funcion creacion prisma
{
	GLfloat vertice[8][3] = {
	...
	glColor3f(1.0, 1.0, 1.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(1.0f - 25 * varX, 0.0f - 25 * varY); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f - 25 * varX, 1.0f - 25 * varY); glVertex3fv(vertice[4]);
	glTexCoord2f(0.0f - 25 * varX, 1.0f - 25 * varY); glVertex3fv(vertice[7]);
	glTexCoord2f(0.0f - 25 * varX, 0.0f - 25 * varY); glVertex3fv(vertice[1]);
	glEnd();
}

void CFiguras::TexturaEstatica(GLuint textura1)  //Funcion creacion prisma
{
...
void CFiguras::Flippers(GLuint textura1, GLuint textura2)  //Funcion creacion
{

	GLfloat vertice[8][3] = {
		{ 0.4 ,-0.5, 0.3 },    //Coordenadas Vértice 0 V0
		{ -0.4 ,-0.5, 0.3 },    //Coordenadas Vértice 1 V1  /////////
		{ -0.1 ,-0.5, -0.7 },    //Coordenadas Vértice 2 V2
		{ 0.1 ,-0.5, -0.7 },    //Coordenadas Vértice 3 V3
		{ 0.4 ,0.5, 0.3 },    //Coordenadas Vértice 4 V4   /////////
		{ 0.1 ,0.5, -0.7 },    //Coordenadas Vértice 5 V5
		{ -0.1 ,0.5, -0.7 },    //Coordenadas Vértice 6 V6
		{ -0.4 ,0.5, 0.3 },    //Coordenadas Vértice 7 V7   /////////
	...
	glColor3f(1.0, 1.0, 1.0);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.9f, 0.1f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.6f, 1.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.3f, 1.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.1f, 0.1f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.1f, 0.1f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.9f, 0.1f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.6f, 1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.3f, 1.0f);  glVertex3fv(vertice[6]);
	glEnd();
}